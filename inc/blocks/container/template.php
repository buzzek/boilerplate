...
<div class="bn-container <?= $spaces ?> <?= $background_pattern ?> <?= $content_align ?> <?= $add_class ?> <?= $visibility ?>" <?= $animation_name ? 'data-aos="'. $animation_name . '"' : "" ?><?= $animation_delay ? 'data-aos-delay="'. $animation_delay .'"' : "" ?>>
